...
const SWEET_MESSAGES = [
    ...
    "I love who how sleepy and relaxed when I'm with you 🌸",
    ...
    "This gloomy weather looks brighter because you're in it ❤️",
    "I love the little things you do that obsessively 🌻",
    "You are my favourite person to forcefully watch shows with 🛋️",
    "The way you care for things — plants, animals, people is ❤️",
    "You make even the hard days feel manageable 💪",
    "I fall asleep grateful every single night when you are beside🌙",
    "You are braver than you know and softer than you show 🦋",
    "Every trip is better with you next to me on the plane (even with turbulence) ✈️",
    ...
    "Your (forced) hugs are genuinely the best in the world 🤗",
    ...
    "You remember the details from 350 BC. That's so rare and scary 🎀",
